...
(
    ...
    output logic                    JALR,                   // signals JALR operation
    ...
    assign xaluArithmeticFlag = (opcode == rvDefs::OPCODE_OP && funct7_5) || 
                            (opcode == rvDefs::OPCODE_OP_IMM && funct3 == 3'b101 && funct7_5); // when to use subtraction instead of addition and arithmetic instead of logical shift
    ...
    assign JALR = (opcode == rvDefs::OPCODE_JALR);
