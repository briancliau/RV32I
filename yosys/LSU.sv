...
// File        : LSU.sv
// Design Unit : LSU
// Description : Load/Store Unit handling byte-lane steering for sub-word memory
//               accesses and 2-phase AHB read-data sign/zero extension.
...
module LSU (
    ...
    // Align Write Data to Correct AHB Byte Lanes (HWDATA)
    always_comb begin
        writeDataLSU = 32'b0;
        case (memoryOpSize)
    ...
    // Extract & Sign/Zero Extend Read Data from Bus (HRDATA)
    always_comb begin
        memToRegData = 32'b0;
    ...
    // Latch address/size for 2nd phase (Data Phase) of memory access
